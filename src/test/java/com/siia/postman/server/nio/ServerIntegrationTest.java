...
import com.siia.postman.server.nio.Test.Ping;
import com.siia.postman.server.nio.Test.Pong;
...
public class ServerIntegrationTest {
    ...
    public void serverShouldSendMessageToOneClient() throws IOException, TimeoutException {
        ...
        startServer(new Consumer<PostmanServerEvent>() {
            ...
            @Override
            public void accept(PostmanServerEvent postmanServerEvent) throws Exception {
                switch (postmanServerEvent.type()) {
                    case CLIENT_JOIN:
